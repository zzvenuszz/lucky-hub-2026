...
//// Admin Gemini Key Endpoints - DUPLICATE: đã move sang routes/admin.routes.ts
...
// ===== DUPLICATE XÓA: user DELETE + PUT routes đã có trong server/routes/user.routes.ts =====
// ===== DUPLICATE XÓA: audit-logs GET route đã có trong server/routes/admin.routes.ts =====
